// basalt: NX journal porting export_attrs.py to C# for nx-bridge automation.
//
// Driven by nx-bridge (JournalManager.PlayDotNetJournal). Produces the same
// v6 sidecar schema as the Python predecessor; see
// docs/superpowers/specs/2026-05-08-NE-11-sub-project-B1-fixtures-design.md
// section 3 Q7 and the schema reference in nx_journals/export_attrs.py (git history).
//
